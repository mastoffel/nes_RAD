...
system("/home/martin/bin/vcftools --vcf data/nes_rad.vcf --out data/inbreeding/nes_filtered --remove-indels --min-alleles 2 --max-alleles 2 --minDP 7 --maxDP 20 --min-meanDP 10 --max-meanDP 20 --max-missing 0.05  --maf 0.01  --recode --recode-INFO-all")
...
get_g2_from_plinkraw <- function(file) {
  ...
  g2 <- g2_snps(x, nboot = 1000, CI = 0.95)
  g2

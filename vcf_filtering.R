...
# include just biallelic
#system("bgzip -c data/nes_rad.vcf > data/nes_rad.vcf.gz")

#system("tabix -p vcf data/nes_rad.vcf.gz")

#system("bcftools view -m2 -M2 -v snps data/nes_rad.vcf.gz > data/nes_rad_biallelic.vcf")
#system("grep -v '#' data/nes_rad_biallelic.vcf | wc -l") # 797768
...
system("plink --file data/inbreeding/maf05_g80 --make-bed --recodeAD --out data/inbreeding/maf05_g80")


#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
#  maf 0.01, 60% geno, GQ 5, DP 8  #
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#

system("vcftools --vcf data/inbreeding/maf05_g80.recode.vcf --geno-depth --out data/inbreeding/raw")
